...
# parser.add_argument('--output_image_path', metavar='output_path', type=str, default='.', help='Path to store the generated image.')
...
# parser.add_argument('--iterations', help='Set the number of iterations to run the optimizer for.', type=int, default=7)
# args = parser.parse_args()
content_image_path = '/Users/mannmann/Desktop/data/s.jpg' # args.content_image_path
style_image_path = './style/starry_night.jpg' 
output_image_path = '.' 
...
for i in range(iterations):
    ...
    fname = os.path.join(output_image_path, 'c_%s_s_%s_cw_%g_sw_%g_tvw_%g_i_%d.png' % (
